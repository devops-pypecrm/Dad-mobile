...
class _CallLogsFilterSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_CallLogsFilterSheet> createState() => _CallLogsFilterSheetState();
}
...
class _CallLogsFilterSheetState extends ConsumerState<_CallLogsFilterSheet> {
  ...
  void _apply() {
    ref.read(callLogsListProvider.notifier).applyFilters(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              usersAsync.valueOrNull != null && usersAsync.valueOrNull!.length > 1
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
